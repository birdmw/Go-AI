...
'''
move_count = 5
move_count_end = move_count+2  # last item not included
game_path = "/home/birdmw/Desktop/final_project/pro_SGFs/1941/12/HayashiYutaro-MaedaNobuaki4362.sgf"
models = [0] * 400
roc_auc = [0] * 400
models[move_count:move_count_end], roc_auc[move_count:move_count_end] = build_models(move_count, move_count_end)
...
#best_move = npboard_table(stats_board(index(max(stats_board))))
#print npboard
print np.round(np.array(stats_board_if_w_plays),1)
print np.round(np.array(stats_board_if_b_plays),1)
#print model_predict(npboard, move_count)
'''